      ...
      if (firebaseUser) {
        ...
        try {
          ...
          if (userDoc.exists()) {
            ...
            if (firebaseUser.email === 'admin@hoangha.com' || firebaseUser.email === 'hoangthanhgolle@gmail.com') {
              userData.role = 'admin';
            }
            ...
            if (isGoogleUser) {
              const newUser: User = {
                ...
                role: (firebaseUser.email === 'admin@hoangha.com' || firebaseUser.email === 'hoangthanhgolle@gmail.com') ? 'admin' : 'user'
              };
